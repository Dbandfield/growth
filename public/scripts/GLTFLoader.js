/* You can not import files from the example directory
of three, when it is used via npm. This is one of those
files which I edited very slightly just to export
via module.exports and import three - daniel */
